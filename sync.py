...
def synchronize_folders(source_path, replica_path):
    for root, dirs, files in os.walk(source_path):
        ...
        try:
            ...
            log_message(f"Error: Deleting File: {item_path}")
    ...
    for filename in files:
        ...
        try:
            ...
            log_message(f"Error: Copying File: {item_path}")
...
def config_log(log_file):
    try:
        logging.basicConfig(filename=os.path.join(log_file, "logs.txt"), level=logging.INFO,
